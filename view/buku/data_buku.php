    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1 text-primary"><i class="fas fa-book me-2"></i>Data Buku</h2>
                    <p class="text-muted mb-0">Manajemen koleksi buku perpustakaan</p>
                </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless mb-0">
                            ...
                            <tbody>
                                <?php foreach($data_buku as $i => $buku): ?>
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm me-3 bg-info bg-opacity-10 text-info">
                                    ...
                                    <td>
                                        <div>
                                            <span class="d-block">Penerbit: <?= $buku['penerbit'] ?></span>
                ...
                <div class="card-footer bg-white border-top-0 pt-0 pb-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted small">
                            Menampilkan <span class="fw-bold"><?= count($data_buku) ?></span> buku
                        </div>
                    </div>
                </div>
            </div>
